...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } opt_output_PWORK;                  /* '<Root>/opt_output' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } opt_input_PWORK;                   /* '<Root>/opt_input' */
  ...
  struct {
    int_T PrevIndex;
  } opt_output_IWORK;                  /* '<Root>/opt_output' */

  struct {
    int_T PrevIndex;
  } opt_input_IWORK;                   /* '<Root>/opt_input' */
...
struct P_helicopter_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Offsetintask3_Value;          /* Expression: 180
                                        * Referenced by: '<Root>/Offset in task3'
                                        */
