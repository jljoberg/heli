...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&helicopter_P.K_ed), 0, 0, 28 },
  ...
  { (char_T *)(&helicopter_P.Offsetintask3_Value), 0, 0, 32 },
