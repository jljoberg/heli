...
legend('x5 - Elevation meassured', 'x5_{ref} - Elevation ref'); title('Elevation, nonLin without feedback');
...
legend('x1 - Travel meassured', 'x1_{ref} - Travel ref'); title('Travel, nonLin without feedback');
xlabel('Time [s]'); ylabel('Angle [deg]');
